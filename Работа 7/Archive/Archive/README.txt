Моя Программа: Классики
Описание:
Это консольное приложение, разработанное на C++. Программа создаёт объект массива и сортирует его.

Системные требования:
- Операционная система: Windows 7, 8, 10 или 11
- Дополнительное ПО не требуется (все библиотеки включены в
программу)
...
- Для выхода из программы используйте пункт меню или закройте
окно.
